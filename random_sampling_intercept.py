# Execute in Terminal to render:  -m manim -pql random_sampling_intercept.py Random_Sampling_Intercept 
import numpy as np
from manim import *
import numpy as np
...
class Random_Sampling_Intercept(MovingCameraScene):
    def construct(self):
        ...
        intro = Text("Random Sampling: Intercept Effects")
        self.add(intro)
        self.wait()
